<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html>    <head>        <meta charset="utf-8" />        <title>云老虎服务商平台</title>		<meta name="keywords" content="云老虎,云老虎服务商平台,云老虎商户平台" />		<meta name="description" content="云老虎,云老虎服务商平台,云老虎商户平台" />        <meta name="viewport" content="width=device-width, initial-scale=1.0" />		<link rel="icon" href="/icon.ico">        <link href="/web1/Public/assets/css/bootstrap.min.css" rel="stylesheet" />        <link rel="stylesheet" href="/web1/Public/assets/css/font-awesome.min.css" />        <link rel="stylesheet" href="/web1/Public/assets/css/ace.min.css" />        <link rel="stylesheet" href="/web1/Public/assets/css/shanghu.css" />        <link rel="stylesheet" href="/web1/Public/assets/css/pageGroup.css" />        <link rel="stylesheet" href="/web1/Public/assets/css/bootstrap-datetimepicker.min.css" />        <!--[if IE 7]>        <link rel="stylesheet" href="/web1/Public/assets/css/font-awesome-ie7.min.css" />        <![endif]-->        <!--[if lte IE 8]>        <link rel="stylesheet" href="/web1/Public/assets/css/ace-ie.min.css" />        <![endif]-->        <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->        <!--[if lt IE 9]>        <script src="/web1/Public/assets/js/html5shiv.js"></script>        <script src="/web1/Public/assets/js/respond.min.js"></script>        <![endif]-->    </head>    <body>        <div class="navbar navbar-default" id="navbar">            <script type="text/javascript">                try {                    ace.settings.check( 'navbar','fixed' )                } catch ( e ) {                }            </script>            <!--head_start-->            <div class="navbar-container" id="navbar-container">                <div class="navbar-header pull-left">                    <a href="/web1/index.php" class="navbar-brand">                        <small> <i class="icon-leaf"></i>                            云老虎服务商平台                        </small>                    </a>                </div>                <div class="pull-left tenant_info">                   用户名：                    <?php if(session('flag') == 1 & session('servicestoretype')==1){ ?>                    <a href="/web1/index.php/Conff/infoDetail"><?php if(!empty($_SESSION['data']['Customer'])): echo ($_SESSION['data']['Customer']); else: echo ($_SESSION['data']['LoginName']); endif; ?></a>                    <?php }else if( session('data')['CustomersType']==1){ ?>                    <a href="/web1/index.php/Conff/MerchantDetail"><?php if(!empty($_SESSION['data']['Customer'])): echo ($_SESSION['data']['Customer']); else: echo ($_SESSION['data']['LoginName']); endif; ?></a>                    <?php }else{ ?>                    <a><?php if(!empty($_SESSION['data']['Customer'])): echo ($_SESSION['data']['Customer']); else: echo ($_SESSION['data']['LoginName']); endif; ?></a>                    <?php } ?>                </div>                <div class="pull-left tenant_info2">名称：<?php if(!empty($_SESSION['data']['DisplayName'])): echo ($_SESSION['data']['DisplayName']); else: echo ($_SESSION['data']['CustomerName']); endif; ?></div>                <div class="navbar-header pull-right" role="navigation">                    <a href="/web1/index.php/Conff/password"> <i class="icon-key"></i>                        修改密码                    </a>                    <a href="/web1/index.php/Login/logout">                        <i class="icon-off"></i>                        退出                    </a>                </div>            </div>        </div>        <!--head_end-->        <!--left_start-->        <div class="main-container" id="main-container">            <script type="text/javascript">                try {                    ace.settings.check( 'main-container','fixed' )                } catch ( e ) {                }            </script>            <div class="main-container-inner">                <a class="menu-toggler" id="menu-toggler" href="index.html">                    <span class="menu-text"></span>                </a>                <div class="sidebar" id="sidebar">                    <script type="text/javascript">                        try {                            ace.settings.check(                                'sidebar'                                ,'fixed' )                        } catch ( e ) {                        }                    </script>                                        <div class="sidebar-shortcuts" id="sidebar-shortcuts">                        <div class="sidebar-shortcuts-mini" id="sidebar-shortcuts-mini">                            <span class="btn btn-success"></span>                            <span class="btn btn-info"></span>                            <span class="btn btn-warning"></span>                            <span class="btn btn-danger"></span>                        </div>                    </div>                    <ul class="nav nav-list">                    <?php if(is_array($list3)): $k1 = 0; $__LIST__ = $list3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($k1 % 2 );++$k1; if(in_array("CONTROLLER_NAME", $list3)){ ?>										 <li class="active"><?php }else{ ?>					<li>					<?php } ?>                        <!-- <?php if(CONTROLLER_NAME == 'Conff'): ?><li class="active">                                <?php else: ?>                            <li><?php endif; ?> -->                        <a href="#" class="dropdown-toggle">                         <img src="/web1/Public/assets/images/ico_cloud.png" alt="">                                <span class="menu-text"><?php echo ($vo1); ?></span> <b class="arrow icon-angle-down"></b>                        </a>                        <ul class="submenu">                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($vo['Description'] == $vo1 ): if(in_array("ACTION_NAME", $newarr)){ ?>												<li class="active"><?php }else{ ?>							<li>							<?php } ?>                             <!-- <?php if(ACTION_NAME == $newarr): ?><li class="active">                                    <?php else: ?>                                <li><?php endif; ?> -->                                <a href="/web1/index.php<?php echo ($vo['URL']); ?>">                                    <i class="icon-double-angle-right"></i><?php echo ($vo['RoleName']); ?><br/>                                </a>                                </li><?php endif; endforeach; endif; else: echo "" ;endif; ?>                         </ul><?php endforeach; endif; else: echo "" ;endif; ?> 										<input type="hidden" value ="<?php echo ($_SERVER['REQUEST_URI']); ?>" id = "URL">                    <div class="sidebar-collapse" id="sidebar-collapse">                        <i class="icon-double-angle-left" data-icon1="icon-double-angle-left" data-icon2="icon-double-angle-right"></i>                    </div>                    <script type="text/javascript">                        try {                            ace.settings.check(                                'sidebar'                                ,'collapsed' )                        } catch ( e ) {                        }												var menu = document.querySelectorAll("a");						var href = document.getElementById("URL").value;						for(var i = 0; i < menu.length; i++){							if(menu[i].getAttribute("href")==href&&menu[i].getAttribute("href")!='/index.php'&&menu[i].getAttribute("href")!='/index.php/Conff/infoDetail'&&menu[i].getAttribute("href")!='/index.php/Conff/MerchantDetail'){								menu[i].style.color = '#ed6639';								menu[i].parentNode.parentNode.style.display='block';							}						}                    </script>                </div>
        ...
        <div class="breadcrumbs" id="breadcrumbs">
          ...
          <ul class="breadcrumb">
            <li>
              ...
              <a href="/web1/index.php">首页</a>
            </li>
            <li>员工二维码生成https://openauth.alipay.com/oauth2/appToAppAuth.htm?app_id=<?php echo (session('AliAppId')); ?>&redirect_uri=http://web.yunlaohu.cn/index.php/Isv/index?systemUserSysNo="</li>
          </ul>
        </div>
  ...
  <!-- jquery库调用-start -->  <!-- <script src="/web1/Public/assets/js/jquery-2.0.3.min.js"></script> -->  <script src="/web1/Public/assets/js/jquery.js"></script>  <script src="/web1/Public/assets/js/ace-extra.min.js"></script>  <script src="/web1/Public/assets/js/jquery.mobile.custom.min.js"></script>  <script src="/web1/Public/assets/js/bootstrap.min.js"></script>  <script src="/web1/Public/assets/js/typeahead-bs2.min.js"></script>  <script src="/web1/Public/assets/js/jquery.dataTables.min.js"></script>  <script src="/web1/Public/assets/js/jquery.dataTables.bootstrap.js"></script>  <script src="/web1/Public/assets/js/ace-elements.min.js"></script>  <script src="/web1/Public/assets/js/ace.min.js"></script>  <script src="/web1/Public/assets/js/date-time/bootstrap-datetimepicker.min.js"></script>  <script src="/web1/Public/assets/js/jquery.validate.min.js"></script>  <script src="/web1/Public/assets/js/page.js"></script>  <!-- <script src="/web1/Public/assets/js/pageGroup.js"></script> -->  <script src="/web1/Public/assets/js/timestamp.js"></script> <script src="/web1/Public/assets/js/common.js"></script>  <!-- jquery库调用-end -->
...
//
//			this.ajaxRequest_ =
//			$.post("/web1/index.php/Test/index2",{SysNo:sysno},function(data){
//		
//			$(".Qrcode").show(300);
//			$(".bg_black").show();
...
//		});
	...
	function DeletClear(sysno,name){
		if (this.ajaxRequest_ != undefined && this.ajaxRequest_.readyState < 4) {
			...
			this.ajaxRequest_ =
			$.post("/web1/index.php/Test/index2",{SysNo:sysno,DeletClear:1},function(data){
  ...
  function infoview(PageNumber,PageSize){
		...
		var tt = "";
			...
			this.ajaxRequest_ =
			$.post("/web1/index.php/Staff/stafflist",{username:username,phone:phone,PageNumber:PageNumber,
      PageSize:PageSize},function(data){ 
			if(data){
				...
				var logintype2 = "<a href = \"https://openauth.alipay.com/oauth2/appToAppAuth.htm?app_id=<?php echo (session('AliAppId')); ?>&redirect_uri=http://web.yunlaohu.cn/index.php/Isv/index?systemUserSysNo="+v.SysNO+"\" class=\"btn btn-danger btn-xs refund2\" target=\"_blank\" >ISV网页授权</a>";
				...
				if(data.AccessFlag==1){
				tt+="<tr><td>"+v.SysNO+"</td><td>"+v.LoginName+"</td><td>"+v.DisplayName+"</td><td>"+v.PhoneNumber+"</td><td>"+v.Email+"</td><td>"+newDate.toLocaleString()+"</td><td>"+logintype+" "+logintypes+" "+logintype1+" "+logintype2+" "+logintype3+" "+logintype4+" "+logintype5+"</td></tr>";
				}else if(data.AccessFlag==1){
				tt+="<tr><td>"+v.SysNO+"</td><td>"+v.LoginName+"</td><td>"+v.DisplayName+"</td><td>"+v.PhoneNumber+"</td><td>"+v.Email+"</td><td>"+newDate.toLocaleString()+"</td><td>"+logintype+" "+logintypes+" "+logintype1+" "+logintype4+" "+logintype5+"</td></tr>";
				}

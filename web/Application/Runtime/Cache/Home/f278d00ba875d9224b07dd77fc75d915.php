...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <!-- <form class="form-horizontal" id="validation-form" method="post" action="/web1/index.php/Staff/staff_list"> -->
    ...
    jQuery( function ( $ ){
        ...
        $( '#validation-form' ).validate( {
            ...
            submitHandler : function ( form ){
              /*  $.ajax( {
                    type : "POST",
                    url : "/web1/index.php/Staff/staff_list",
                    data : {
                        sx_dlm : $( "#sx_dlm" ).val(),
                        sx_pass : $(
                            "#sx_pass" ).
...
<script>
    ...
    function infoview(PageNumber,PageSize){
		...
		var tt = "";
			...
			if(data){
				...
				tt+="<tr><td>"+v.SysNO+"</td><td>"+v.LoginName+"</td><td>"+v.DisplayName+"</td><td>"+v.PhoneNumber+"</td><td>"+v.Email+"</td><td>"+v.DwellAddress+"</td><td>"+v.Alipay_store_id+"</td><td>"+newDate.toLocaleString()+"</td><td>"+logintype+"</td><td>"+list+"</td></tr>";
				});
			$("#info").html(tt);
    ...
    function businessview(SysNo){
    	window.location.href="/web1/index.php/Business/business?id="+SysNo;
    }

    function orderview(SysNo){
    	window.location.href="/web1/index.php/Order/order_search?SystemUserSysNo="+SysNo;
    }

    function rateview(TopSysNo){
    	window.location.href="/web1/index.php/OrderFund/orderfund?TopSysNo="+TopSysNo;
    }
    function customerrateview(CustomerSysNo){
    	window.location.href="/web1/index.php/OrderFund/orderfund?CustomerSysNo="+CustomerSysNo;
    }

    function businessregister(SysNo){
        window.location.href="/web1/index.php/Business/business_register?SystemUserSysNo="+SysNo;
    }
    function codelist(SysNo){
        window.location.href="/web1/index.php/QRCodeList/codelist/?topid="+SysNo;
    }
